...
class Customercustomerdemo(Base):
    ...
    CustomerID = Column(Text, primary_key=True, nullable=False)
    CustomerTypeID = Column(Text, primary_key=True, nullable=False)


class Customerdemographic(Base):
    __tablename__ = 'customerdemographics'

    CustomerTypeID = Column(Text, primary_key=True)
...
class Customer(Base):
    ...
    CustomerID = Column(Text, primary_key=True)
...
class Region(Base):
    ...
    RegionDescription = Column(Text, nullable=False)
...
class Territory(Base):
    ...
    TerritoryDescription = Column(Text, nullable=False)
